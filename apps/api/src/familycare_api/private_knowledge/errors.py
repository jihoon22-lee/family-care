...
class PublicationErrorCode(StrEnum):
    """Stable, value-free failures for reviewed publication packages."""
    ...
    DUPLICATE_CANONICAL_KEY = "DUPLICATE_CANONICAL_KEY"
    BROKEN_REFERENCE = "BROKEN_REFERENCE"
    INCOMPLETE_DISPOSITION_CLOSURE = "INCOMPLETE_DISPOSITION_CLOSURE"
    UNSUPPORTED_DSL = "UNSUPPORTED_DSL"
    EXECUTABLE_INPUT = "EXECUTABLE_INPUT"
...
class PublicationPackageError(ValueError):
    """Publication failure containing only stable coordinates."""
