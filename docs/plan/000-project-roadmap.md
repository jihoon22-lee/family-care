...
- 현재 코드 버전: `v0.5.0`; 태그·이미지·실제 적용 상태는 [v0.5 수용 원장](../release/v0.5.0-verification.md)에서 별도 추적
...
2026-09-09 현재 B01–B08 구현과 후속 PR #84–#86이 통합됐으며 보호 자료 지원은 PARTIAL이다.
최종 릴리스·전환 상태는 GitHub의 실제 이슈·PR·실행 증거와 수용 원장을 확인한다. 이 문서는 완료율을 복제하지 않는다.
