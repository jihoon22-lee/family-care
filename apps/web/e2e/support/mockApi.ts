...
function resultResponse(
  ...
  return {
    analysis_completeness: partial ? "PARTIAL" : "COMPLETE",
    assistance: {
      mode: "NONE",
      model_label: null,
    ...
    candidates: [
      {
        ...
        source: { kind: "OPERATIONAL_RIDER", rider_id: RIDER_MATCH_ID },
      },
      {
        ...
        source: { kind: "OPERATIONAL_RIDER", rider_id: RIDER_UNKNOWN_ID },
      },
    ],
    catalog_coverage: {
