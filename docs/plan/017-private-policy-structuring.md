...
5. [ ] Continue root-owned actual family-by-family analysis outside Git after synthetic acceptance:
   ...
   - [x] Family C source review complete from 17 PDFs and 1 image: 15 readable and 3 password-required sources, yielding 5 readable certificate-backed policies and 39 coverages. Three certificate candidates remain unpublished after the verified six-digit birth-date attempt. All statuses remain `UNKNOWN` pending current/renewal verification.
   - [x] Family B source review complete from 18 PDFs: 16 readable and 2 password-required sources, yielding 7 readable certificate-backed policies and 97 coverages. Two certificate candidates remain unpublished after the verified six-digit birth-date attempt, and one legacy-font certificate retains an exact-label boundary. All statuses remain `UNKNOWN` pending current/renewal verification.
   - [x] Family D source review complete from 21 readable PDFs, yielding 6 certificate-backed policies and 109 coverages. The previously inaccessible supporting source opened with the verified six-digit birth date and remains excluded from policy authority. All statuses remain `UNKNOWN` pending current/renewal verification.
   - [x] Family A source review complete from 37 readable PDFs, yielding 15 certificate-backed policies and 163 coverages. Two certificates opened with the verified six-digit birth date; mixed-role source files and same-member duplicates were reviewed without inflating the aggregate. All statuses remain `UNKNOWN` pending current/renewal verification.
   - [x] Recheck every previously inaccessible source with an empty password and, only where still required, the root-verified six-digit birth date. This corrected seven restricted-but-readable PDFs and opened three genuinely password-protected files without recording the password or birth date.
   - [x] Recheck the remaining encrypted sources against every root-verified family birth-date candidate, not only the selected member's candidate. Two additional policy sources opened under this cross-family policyholder/insured boundary; five sources remain password-required after all verified candidates failed.
   - [x] Apply the user-confirmed Samsung Fire document convention: a Samsung Fire source titled `상품설명서` is an issued policy certificate, not a standalone product explanation. Root review confirmed all seven matching sources as certificate-backed contracts, corrected five previously missing or misclassified registrations, kept every status `UNKNOWN`, and published no rider without conclusive enrollment Evidence. A separate non-Samsung source with that title remains outside this convention and was not automatically reclassified.
   - [ ] Complete the five remaining password-required certificate candidates and legacy-font/raw-visual boundaries, and verify current/renewal status before changing any `UNKNOWN` result.
