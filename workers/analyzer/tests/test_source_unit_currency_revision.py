"""Proven context processing preserves old source contracts and refuses lossy downgrade."""
...
PREVIOUS = "0082_proven_draft_context"
REVISION = "0083_source_unit_currency"
PIPELINE = "retained-policy-association-v14"


def test_source_unit_currency_migration_roundtrip_and_history_guard(retained_source):
