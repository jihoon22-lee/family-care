...
5. 진행 중 받은 예산 승인·설명 질문·상태 요청은 기존 작업의 후속 지시로 반영합니다. 이미 승인된 작업을 중간 보고만 남기고 종료하지 않습니다. 완료하거나 사용자 취소·필수 입력 부재·실제 권한/비용 한도처럼 더 진행할 수 없는 사유가 있을 때 종료하며, 독립적으로 진행 가능한 구현은 계속합니다.
