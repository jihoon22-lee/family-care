...
- Recognize spaced insured/contract labels without changing source identity, and redact their
  values before provider-bound window clipping. Preserve earlier processing with a new explicit revision.
