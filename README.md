...
Web/API/Worker의 개발·최종 릴리스 목표 버전은 `0.5.0`, 지원 DB schema는 `0071_source_calculations`입니다.
v0.5.0 마일스톤은 개발 중이며 최종 릴리스는 아직 게시하지 않았습니다.
...
잘못 게시한 v0.5.x 릴리스·태그는 사용자 지시에 따라 제거했습니다. 구현한 기능은 유지하고
개발 버전을 v0.5.0으로 통일합니다. 마일스톤 개발과 수용 검증을 마친 뒤 v0.5.0 태그를
새로 게시하고 배포합니다. 현재 실행 환경의 이력은 [수용 원장](docs/release/v0.5.0-verification.md)에 구분해 기록합니다.
